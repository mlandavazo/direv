        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    //add new photo to "photos" node and "user_photos" node on firebase
                ...
                public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if(progress - 15 > mPhotoUploadProgress){
                        Toast.makeText(mContext, "Uploading photo: " + String.format("%.0f", progress) + "% completed", Toast.LENGTH_SHORT).show();
...
//    }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            if (password.length() < 6){
                                Toast.makeText(mContext, R.string.password_short,
     ...
     * @param lastname
     */
    public void addNewUser(String firstname, String lastname, String email, String username,  String profile_photo){
        Log.d(TAG, "first: " + firstname);
        Log.d(TAG, "last: " + lastname);
        Log.d(TAG, "email: " + email);
        Log.d(TAG, "username: " + username);
        User user = new User( firstname, lastname, userID,  email,  username );
