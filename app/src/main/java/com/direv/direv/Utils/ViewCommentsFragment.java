...
public class ViewCommentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            Log.d(TAG, "retrieved restaurant key: " + mPhoto.getRestaurant_key());
            setupFirebaseAuth();
    ...
    private void setupWidgets(){
        ...
        mBackArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getCallingActivityFromBundle().equals(getString(R.string.feed_activity))){
                    getActivity().getSupportFragmentManager().popBackStack();
                    ((FeedActivity)getActivity()).showLayout();

                }
                else if (getCallingActivityFromBundle().equals(getString(R.string.restaurant_activity))){
                    getActivity().getSupportFragmentManager().popBackStack();
                    ((RestaurantActivity)getActivity()).showLayout();
                }
                else{
                    getActivity().getSupportFragmentManager().popBackStack();
                }
    ...
    private void addNewComment(String newComment){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment + " to restaurant "
        + mPhoto.getRestaurant_key());
        ...
        //insert into restaurant_photos node
        myRef.child(getString(R.string.dbname_restaurant_photos))
                .child(mPhoto.getRestaurant_key())
                .child(mPhoto.getPhoto_id())
                .child(getString(R.string.field_comments))
                .child(commentID)
                .setValue(comment);
    ...
    private String getCallingActivityFromBundle(){
        ...
        String restaurantActivity = bundle.getString("Restaurant Activity");
        String feedActivity = bundle.getString("Feed Activity");
        if(bundle != null && feedActivity != null) {
            Log.d(TAG, "getPhotoFromBundle: calling activity: " + feedActivity);
            return bundle.getString(getString(R.string.feed_activity));
        }
        else if(bundle != null && restaurantActivity != null){
            Log.d(TAG, "getPhotoFromBundle: calling activity: " + restaurantActivity);
            return bundle.getString(getString(R.string.restaurant_activity));
        }
        else{
            return null;
        }
