...
/**
 * Created by khinthein on 12/03/17.
 */
...
public class NextActivity extends AppCompatActivity{
    ...
    private void someMethod(){
        ...
        Step 3: count number of photos user already has
        Step 4: upload photo to firebase storage and insert 2 new nodes in firebase database
            a) photos node
            b) user_photos node
         */
